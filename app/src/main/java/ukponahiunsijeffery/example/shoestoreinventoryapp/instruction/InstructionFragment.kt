package ukponahiunsijeffery.example.shoestoreinventoryapp.instruction
...
import ukponahiunsijeffery.example.shoestoreinventoryapp.databinding.FragmentInstructionBinding
...
class InstructionFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.insructionNextButton.setOnClickListener { view : View ->
